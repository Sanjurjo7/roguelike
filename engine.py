...
def play_game(player, entities, game_map, message_log, game_state, con, panel, constants):
    ...
    while not libtcod.console_is_window_closed():
        ...
        render_all(con, panel, entities, player, game_map, fov_map, 
                fov_recompute, message_log, constants['screen_width'], constants['screen_height'], 
                constants['bar_width'], constants['panel_height'], constants['panel_y'], mouse, game_state)
        ...
        for player_turn_result in player_turn_results:
            ...
            if equip:
                ...
                for equip_result in equip_results:
                    ...
                    if dequipped:
                        message_log.add_message(Message('You have removed the {0}'.format(dequipped.name)))
