...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size,
        ...
        for r in range(max_rooms):
            ...
            for other_room in rooms:
                ...
                # this means there are no intersections, so valid
                ...
                if num_rooms == 0:
                    # this is the first room, where the players starts
                    player.x = new_x
                    player.y = new_y
                else:
                    ...
                    # flip a coin (random number that is either - or 1)
                    if randint(0,1) == 1:
                        # first move horizontally, then vertically
                        self.create_h_tunnel(prev_x, new_x, prev_y)
                        self.create_v_tunnel(prev_y, new_y, new_x)
                    else:
                        # virst move vertically, then horizontally
    ...
    def place_entities(self, room, entities):
        ...
        item_chances = {
            'healing_potion': 35,
            'dirk': from_dungeon_level([[10, 2]], self.dungeon_level),
